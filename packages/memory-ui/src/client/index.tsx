...
export const name = '@memorax-agent/dsh-memory-ui'
export const inject = ['slots', 'locale', 'uiContainer'] as const

export function apply(ctx: ClientContext): void {
  const t = ctx.locale.bind(NS)
  const { surface, disconnect } = ctx.uiContainer.connectSurface({ id: 'patchouli.memory' })
  ...
  ctx.effect(() => ctx.uiContainer.documents.registerProvider({
    scheme: 'patchouli',
    describe: (uri) => {
