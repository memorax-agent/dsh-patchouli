...
unit records its canonical scope, one provider-local published cursor and immutable policy descriptor when
...
metadata, and session frontiers advance atomically with publication. Change
