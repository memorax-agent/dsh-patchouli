...
| `@memorax-agent/dsh-memory-ui` | web UI plugin | `patchouli-memory-ui` | `@memorax-agent/dsh-memory-ui@<version>` |
| `@memorax-agent/patchouli-protocol` | harness-neutral library | none | `@memorax-agent/patchouli-protocol@<version>` |
